...
model = YOLO("C:/Users/lab11/PycharmProjects/pythonProject5/yolo_weights/yolov8_fall_detection.pt")  # Adjust path if needed
classNames = ['Falling', 'Kneeling', 'Sitting', 'Sleeping','Standing','Unknown']
# Open video source (adjust path or use webcam as needed)
cap = cv2.VideoCapture("C:/Users/lab11/PycharmProjects/pythonProject5/videos/video2.mp4")
...
while True:
    ...
    # Resize image
    img = cv2.resize(img, (800, 600))  # Adjust width and height as needed
